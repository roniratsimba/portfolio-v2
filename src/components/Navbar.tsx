  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Action button: shadcn Button with custom navCta variant */}
        <Button
          id="nav-contact-button"
          variant="navCta"
          size="lg"
          onClick={onOpenContact}
          className="hidden sm:inline-flex rounded-lg uppercase text-xs tracking-widest px-5 lg:px-6 gap-1.5"
        >
